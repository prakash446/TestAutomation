...
public class CSSSelectorDemo {
	...
	static void navigate()
	{
		try
		{
			oBrowser.get("file:\\D:\\sai\\COURSES\\Java Course\\notes\\selenium Sample.html");
			Thread.sleep(2000);
		}catch(Exception e)
		{
			e.printStackTrace();
	...
	{
		oBrowser.findElement(By.cssSelector("form#frm3 >input + input ")).sendKeys("DemoUser12345");
	}
