...
public class CreateModifyDeleteUser {
	...
	static void modifyuser()
	{
		try
		{
			...
			Browser.findElement(By.name("firstName")).sendKeys("person");
			Browser.findElement(By.name("lastName")).clear();
			Browser.findElement(By.name("lastName")).sendKeys("newUser");
			Browser.findElement(By.name("email")).clear();
			Browser.findElement(By.name("email")).sendKeys("person@gmail.com");
			Browser.findElement(By.name("username")).clear();
			Browser.findElement(By.name("username")).sendKeys("demoUser2");
